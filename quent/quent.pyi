...
from quent import ResultOrAwaitable
...
class Chain:
  ...
  def decorator(self) -> Callable[[Callable], Callable[[...], ResultOrAwaitable[Any]]]: ...

  def run(self, v: RootLink = None, *args: P.args, **kwargs: P.kwargs) -> ResultOrAwaitable[Any]: ...
  ...
  def __call__(self, v: RootLink = None, *args: P.args, **kwargs: P.kwargs) -> ResultOrAwaitable[Any]: ...
...
class ChainAttr(Chain):
  ...
  def __call__(self, *args, **kwargs) -> Self | ResultOrAwaitable[Any]: ...
